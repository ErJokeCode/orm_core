...
class BaseModelOrm(Generic[M, I, E, O]):
    ...
    async def get_all(
        self,
        session: AsyncSession,
        query_select: Union[Select, None] = None,
    ...
    async def get_all(
        ...
        is_model: bool = True
    ) -> Union[ListDTO[O], Sequence[O], ListDTO[M], Sequence[M]]:
    ...
    async def get_by(
        ...
        loads: Union[dict[str, str], None] = None,
        *,
        is_model: Literal[False] = False,
    ...
    async def delete(
        ...
        session: AsyncSession,
        id: Union[UUID, int],
        query_has_child: Union[Select, None] = None
    ) -> ResponseStatus:
